...
export const  Olvidar = () => {
  ...
  return (
    <>
      <Toaster richColors />
      <Container maxWidth="sm" sx={{display:'flex', justifyContent:'center' , alignItems:'center' , height:'100vh' ,flexDirection: 'column'}}>
        ...
        { step1 && (
          ...
          >
            <Container maxWidth="sm" sx={{display:'flex' , justifyContent:'center'}}>
              <Card variant="outlined" sx={{padding:3, marginTop:5 ,width: '500px'}}>
                <CardContent>
                  <Box sx={{display:'flex' , justifyContent:'center'}}>
                  ...
                  <Box sx={{marginTop:3}}>
                    <Typography variant='subtitle1' align='left'>
                      ...
                      un código para recuperar tu contraseña.
                    </Typography>
                  </Box>
                  <Box sx={{marginTop:3 , display:'flex', flexDirection: 'column', justifyContent:'center'}}>
                  ...
                  <CardContent>
                    ...
                    <form onSubmit={handleSubmit2(onSubmit2)}>
                        <TextField 
                          ...
                          {...register2("codigoForm", { required: true })}
                        />
                        {errors2.codigoForm &&
                          <Typography variant="subtitle1" color="error">
                            Ingrese codigo
                    ...
                    <Box sx={{marginTop:3 , display:'flex', flexDirection: 'column', justifyContent:'center'}}>
                      <form onSubmit={handleSubmit3(onSubmit3)}>
                        <TextField
                          ...
                          fullWidth
                          sx={{ marginTop: 3 }}
                          {...register3("contrasena", { required: true })}
                        />
                        {errors3.contrasena &&
                          <Typography variant="subtitle1" color="error">
